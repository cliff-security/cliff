...
--
-- Backfill posture findings persisted by older builds (source_type='opensec-posture',
...
-- the source of truth is opensec.assessment.posture.CHECK_SEVERITY / CHECK_DISPLAY_NAME /
-- CHECK_DESCRIPTION. Keep them in sync on changes.

UPDATE finding
SET source_type = 'cliff'
WHERE type = 'posture' AND source_type = 'opensec-posture';
