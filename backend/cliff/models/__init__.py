"""Pydantic domain models for Cliff entities.
...
so that ``from cliff.models import Foo`` keeps working for every call site
...
from cliff.models.completion import (
    Completion,
    CompletionCreate,
    ShareAction,
)
from cliff.models.finding import (
    Finding,
    FindingCreate,
    FindingGradeImpact,
    FindingStatus,
...
from cliff.models.posture_check import (
