...
async def run_triage(
    ...
    *,
    ...
    return await _run_scanner_triage(executor, db, workspace, env_vars=env_vars)
...
async def _run_scanner_triage(
    ...
    *,
    ...
    triage = synthesize_triage(enrichment, exposure)
    await _persist_synthesis(db, workspace.id, triage)
    return triage
