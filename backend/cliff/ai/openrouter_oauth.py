...
# overrides this to ``0.0.0.0`` via ``CLIFF_OAUTH_CALLBACK_HOST`` so the
...
_HTML_BODY = (
    ...
    "<title>Cliff — authorized</title></head><body style='"
    ...
    "<p>Cliff received the authorization. Head back to the app to continue.</p>"
    "</body></html>"
)
        ...
        try:
            if (
                ...
                await _write_response(
                    writer, 400, "<p>Cliff rejected the callback.</p>"
                )
        finally:
