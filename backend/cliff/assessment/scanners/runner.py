...
The runner is the single point at which Cliff hands control to a third-party
...
def _skip_dirs_csv() -> str:
    ...
    :func:`cliff.assessment._fs.iter_repo_files` exclusion has no effect on
    ...
    similar test-data directories — including on the Cliff repo itself.
