...
finishing is bounded two ways:
  ...
  * A separate watchdog loop in :mod:`cliff.main` reaps any
...
from cliff.db.dao.assessment import set_assessment_result, update_assessment
from cliff.db.dao.completion import (
    create_completion,
...
if TYPE_CHECKING:
    ...
    from cliff.api._engine_dep import AssessmentEngineProtocol
