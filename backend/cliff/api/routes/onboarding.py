...
from cliff.api._background import schedule_assessment_run
...
# (backend/cliff/integrations/registry/github.json) and read by the
...
async def _upsert_github_integration(
    ...
    if vault is None:
        ...
        # operators know to set CLIFF_CREDENTIAL_KEY. The Integrations row
        ...
        logger.warning(
            ...
            "Set CLIFF_CREDENTIAL_KEY to enable durable credential storage."
        )
        return
