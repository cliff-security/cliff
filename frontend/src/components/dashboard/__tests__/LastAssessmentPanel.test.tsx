  ...
  scanners: [
    {
      ...
      duration_ms: 38_400,
      result: { kind: 'findings_count' as const, value: 7, text: '7 findings' },
    },
    {
      id: 'semgrep',
      ...
      duration_ms: 71_200,
      result: { kind: 'findings_count' as const, value: 3, text: '3 findings' },
    },
    {
      id: 'posture',
      ...
      duration_ms: 9_600,
      result: { kind: 'pass_count' as const, value: 12, text: '12 pass' },
    },
  ],
}
